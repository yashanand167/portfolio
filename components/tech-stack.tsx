...
function TechBadge({ name, icon: Icon, color, useForeground }: TechItem) {
  return (
    <span className="relative z-10 inline-flex items-center gap-1.5 rounded-md border border-border bg-card px-2 py-1 text-xs font-medium text-foreground shadow-2xs transition-colors hover:bg-muted sm:gap-2 sm:rounded-lg sm:px-3 sm:py-2 sm:text-sm">
      <Icon
        className={cn(
